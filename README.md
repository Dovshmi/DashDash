...
- **זמן אישי** — לחיצה אחת להתחלה ולחיצה שנייה לסיום; מציג זמן חי, סיכום יומי ורשימת ההפעלות האחרונות. אפשר להגדיר כתובת מייל וסף `MM:SS` להתראה אחת אוטומטית, כל עוד האתר פתוח.
...
התכונה עובדת בזמן שהאתר פתוח בלבד. המשתמש מזין כתובת יעד וסף `MM:SS`; כאשר הטיימר מגיע לסף, DashDash שולח הודעה אחת דרך `/api/send-time-alert`.
